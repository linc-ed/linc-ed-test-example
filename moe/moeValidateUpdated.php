...
public function check_linc_fields(){
	
	$number = 2000;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_1_type",  "Field Label"=>"First contact type", "Field No"=>$number, "LINC Name"=>"contact_1_type","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
'options'=> array( array('value'=>'mother', 'label'=>'Mother'),
array('value'=>'father', 'label'=>'Father'),
...
if ($this->moe[$number]['valid']=='false'){
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup" data-theme="b" data-type="horizontal">';
		...
		foreach ($this->moe[$number]['options'] as $option){
										...
										if ($this->moe[$number]['value'] == $option['value']){
									$this->moe[$number]['input_field'] .= '<h1 >'.$option ['label'].'</h1>';
...
$number = 2001;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_2_type",  "Field Label"=>"Second contact type:", "Field No"=>$number, "LINC Name"=>"contact_2_type","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2002;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"liveswith",  "Field Label"=>"Lives with:", "Field No"=>$number, "LINC Name"=>"liveswith","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
'options'=> array( array('value'=>'both', 'label'=>'Both parents'),
array('value'=>'mother', 'label'=>'Mother'),
array('value'=>'father', 'label'=>'Father'),
array('value'=>'other', 'label'=>'Other')
)
);
...
if ($this->moe[$number]['valid']=='false'){
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup"  data-theme="b" data-type="horizontal">';
			...
			$this->moe[$number]['input_field'] .= '<input data-theme="b" data-arraypos="'.$number.'" class="radioButton" type="radio" data-id="'.$this->person_id.'" data-value="'.$option['value'].'" name="'.$this->moe[$number]['LINC Name'].'" id="radio-'.$this->moe[$number]['LINC Name'].'-'.$option['value'].'" value="'.$option['value'].'"  ';
				...
				$this->moe[$number]['input_field'] .= '</fieldset>';
$number = 2003;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"caregiver_comment",  "Field Label"=>"Comment", "Field No"=>$number, "LINC Name"=>"caregiver_comment","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';
$number = 2004;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"access_arrangements",  "Field Label"=>"Custody/ Access arrangements the school needs to be aware of: (a copy of any custody orders must be provided for the school)", "Field No"=>$number, "LINC Name"=>"access_arrangements","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2005;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"screen",  "Field Name"=>"digital_safety",  "Field Label"=>"Digital safety form", "Field No"=>$number, "LINC Name"=>"digital_safety","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
array('value'=>'noform', 'label'=>'Form not returned')
)
);

$data = strtolower($this->mappedData[$this->moe[$number]['LINC Name']]);
...
$number = 2006;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"screen",  "Field Name"=>"digital_comment",  "Field Label"=>"Digital safety comment", "Field No"=>$number, "LINC Name"=>"digital_comment","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2007;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"trip_permission_1",  "Field Label"=>"Trip Permission Form - Term 1", "Field No"=>$number, "LINC Name"=>"trip_permission_term_1","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2008;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"trip_permission_2",  "Field Label"=>"Trip Permission Form - Term 2", "Field No"=>$number, "LINC Name"=>"trip_permission_term_2","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2009;
$this->moe[$number]=array("Field Name"=>"Emergenacy 1 First Name", "ICON"=> "user-plus",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact First Name", "LINC Name"=>"emergency1_first","Field No"=>$number, "Description"=>"First Name of the first emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2010;
$this->moe[$number]=array("Field Name"=>"Emergenacy 1 SURNAME", "ICON"=> "user-plus",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact Last Name", "LINC Name"=>"emergency1_last","Field No"=>$number, "Description"=>"Surname of the first emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2011;
$this->moe[$number]=array("Field Name"=>"Emergency 1 phone", "ICON"=> "phone",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact Phone Numbers", "LINC Name"=>"emergency1_phone","Field No"=>$number, "Description"=>"Phone numbers for first emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2012;
$this->moe[$number]=array("Field Name"=>"Emergency 1 mobile", "ICON"=> "mobile",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact Mobile Number", "LINC Name"=>"emergency1_mobile","Field No"=>$number, "Description"=>"Mobile phone number for first the first emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2013;
$this->moe[$number]=array("Field Name"=>"Emergenacy 2 First Name", "ICON"=> "user-plus",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact First Name", "LINC Name"=>"emergency2_first","Field No"=>$number, "Description"=>"First Name of the second emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2014;
$this->moe[$number]=array("Field Name"=>"Emergenacy 2 SURNAME", "ICON"=> "user-plus",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact Last Name", "LINC Name"=>"emergency2_last","Field No"=>$number, "Description"=>"Surname of the second emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2015;
$this->moe[$number]=array("Field Name"=>"Emergenacy 2 phone", "ICON"=> "phone",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact Phone Numbers", "LINC Name"=>"emergency2_phone","Field No"=>$number, "Description"=>"Phone number for second emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2016;
$this->moe[$number]=array("Field Name"=>"Emergenacy 2 mobile", "ICON"=> "mobile",  "Content Type"=> "metacontent","Field Label"=>"Emergency Contact Mobile Number", "LINC Name"=>"emergency2_mobile","Field No"=>$number, "Description"=>"Mobile phone number for first the second emergency contact person.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2017;
$this->moe[$number]=array("Field Name"=>"Medical Notes", "ICON"=> "heart-2",  "Content Type"=> "metacontent","Field Label"=>"Medical Notes", "LINC Name"=>"medical_notes","Field No"=>$number, "Description"=>"Medical notes.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2018;
$this->moe[$number]=array("Field Name"=>"Medical Condition", "ICON"=> "heart-2",  "Content Type"=> "metacontent","Field Label"=>"Medical Condition", "LINC Name"=>"medical_condition","Field No"=>$number, "Description"=>"Medical conditions.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2019;
$this->moe[$number]=array("Field Name"=>"Medical Treatment", "ICON"=> "heart-2",  "Content Type"=> "metacontent","Field Label"=>"Medical Treatment", "LINC Name"=>"medical_treatment","Field No"=>$number, "Description"=>"Medical treatment.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2020;
$this->moe[$number]=array("Field Name"=>"Allergies", "ICON"=> "heart-2",  "Content Type"=> "metacontent","Field Label"=>"Allergies", "LINC Name"=>"allergy","Field No"=>$number, "Description"=>"Allergies.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2021;
$this->moe[$number]=array("Field Name"=>"ESOL Number", "ICON"=> "earth",  "Content Type"=> "metacontent","Field Label"=>"ESOL Number", "LINC Name"=>"esol_number","Field No"=>$number, "Description"=>"ESOL Number.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$this->moe[$number]['input_field'] = '<input type="number" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';		
	...
	$number = 2022;
$this->moe[$number]=array("Field Name"=>"Critical Information", "ICON"=> "heart-2",  "Content Type"=> "metacontent","Field Label"=>"critical_info", "LINC Name"=>"critical_info","Field No"=>$number, "Description"=>"Critical Information.","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>''
...
$number = 2023;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"trip_permission_3",  "Field Label"=>"Trip Permission Form - Term 3", "Field No"=>$number, "LINC Name"=>"trip_permission_term_3","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
if ($this->moe[$number]['valid']=='false'){
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup"  data-theme="b" data-type="horizontal">';
			...
			$this->moe[$number]['input_field'] .= '<input data-theme="b" data-arraypos="'.$number.'" class="radioButton" type="radio" data-id="'.$this->person_id.'" data-value="'.$option['value'].'" name="'.$this->moe[$number]['LINC Name'].'" id="radio-'.$this->moe[$number]['LINC Name'].'-'.$option['value'].'" value="'.$option['value'].'"  ';
				...
				$this->moe[$number]['input_field'] .= '</fieldset>';	
				$number = 2024;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"trip_permission_4",  "Field Label"=>"Trip Permission Form - Term 4", "Field No"=>$number, "LINC Name"=>"trip_permission_term_4","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2025;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"camp_permission",  "Field Label"=>"Camp Permission Form", "Field No"=>$number, "LINC Name"=>"camp_permission","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
if ($this->moe[$number]['valid']=='false'){
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup"  data-theme="b" data-type="horizontal">';
			...
			$this->moe[$number]['input_field'] .= '<input data-theme="b" data-arraypos="'.$number.'" class="radioButton" type="radio" data-id="'.$this->person_id.'" data-value="'.$option['value'].'" name="'.$this->moe[$number]['LINC Name'].'" id="radio-'.$this->moe[$number]['LINC Name'].'-'.$option['value'].'" value="'.$option['value'].'"  ';
				...
				$this->moe[$number]['input_field'] .= '</fieldset>';	
$number = 2026;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"swimming_permission",  "Field Label"=>"Swimming Permission Form", "Field No"=>$number, "LINC Name"=>"swimming_permission","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
if ($this->moe[$number]['valid']=='false'){
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup"  data-theme="b" data-type="horizontal">';
			...
			$number = 2027;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_1_email",  "Field Label"=>"First contact email address", "Field No"=>$number, "LINC Name"=>"contact_1_email","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';	
		...
		$number = 2028;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_2_email",  "Field Label"=>"Second contact email address", "Field No"=>$number, "LINC Name"=>"contact_2_email","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';	
		...
		$number = 2029;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"religious_education",  "Field Label"=>"Religious Education", "Field No"=>$number, "LINC Name"=>"religious_education","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
if ($this->moe[$number]['valid']=='false'){
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup"  data-theme="b" data-type="horizontal">';
		...
		$number = 2030;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"trip_permission",  "Field Label"=>"Trip Permission Form", "Field No"=>$number, "LINC Name"=>"trip_permission","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup"  data-theme="b" data-type="horizontal">';
			...
			$this->moe[$number]['input_field'] .= '<input data-theme="b" data-arraypos="'.$number.'" class="radioButton" type="radio" data-id="'.$this->person_id.'" data-value="'.$option['value'].'" name="'.$this->moe[$number]['LINC Name'].'" id="radio-'.$this->moe[$number]['LINC Name'].'-'.$option['value'].'" value="'.$option['value'].'"  ';
				...
				$this->moe[$number]['input_field'] .= '</fieldset>';
					...
					$number = 2031;
	$this->moe[$number]=array("Content Type"=> 'metacontent',"ICON"=>"checkbox-checked",  "Field Name"=>"immunisations",  "Field Label"=>"Immunisations complete?", "Field No"=>$number, "LINC Name"=>"immunisations","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
array('value'=>'no', 'label'=>'No'),
array('value'=>'yes', 'label'=>'Yes'),
array('value'=>'noform', 'label'=>'Unknown')
)
);
...
$number = 2032;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_email",  "Field Label"=>"Third contact email address", "Field No"=>$number, "LINC Name"=>"contact_3_email","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2033;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_first_name",  "Field Label"=>"Third contact first name", "Field No"=>$number, "LINC Name"=>"contact_3_first_name","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2034;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_last_name",  "Field Label"=>"Third contact last name", "Field No"=>$number, "LINC Name"=>"contact_3_last_name","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';	
	...
	$number = 2035;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_type",  "Field Label"=>"Third contact type", "Field No"=>$number, "LINC Name"=>"contact_3_type","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
if ($this->moe[$number]['valid']=='false'){
	...
	$this->moe[$number]['input_field'] .= '<fieldset data-role="controlgroup" data-theme="b" data-type="horizontal">';
		...
		foreach ($this->moe[$number]['options'] as $option){
				...
				$number = 2036;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_address1",  "Field Label"=>"Third contact address line 1", "Field No"=>$number, "LINC Name"=>"contact_3_address1","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';	
	...
	$number = 2037;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_address2",  "Field Label"=>"Third contact address line 2", "Field No"=>$number, "LINC Name"=>"contact_3_address2","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';	
				...
				$number = 2038;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_address3",  "Field Label"=>"Third contact address line 3", "Field No"=>$number, "LINC Name"=>"contact_3_address3","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';	
	...
	$number = 2039;
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_address4",  "Field Label"=>"Third contact address line 4", "Field No"=>$number, "LINC Name"=>"contact_3_address4","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]['input_field'] = '<input type="text" class="'.$this->moe[$number]['Content Type'].'" data-arraypos="'.$this->moe[$number]['Field No'].'" name="'.$this->moe[$number]['LINC Name'].'" data-id="'.$this->person_id.'" id="'.$this->moe[$number]['LINC Name'].$this->person_id.'" value="'.$this->moe[$number]['value'].'" data-theme="'.$theme.'" placeholder="'.$this->moe[$number]['Placeholder'].'"/>';	
	...
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_address5",  "Field Label"=>"Third contact postcode", "Field No"=>$number, "LINC Name"=>"contact_3_address5","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2041;
	...
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_phone",  "Field Label"=>"Third contact phone number", "Field No"=>$number, "LINC Name"=>"contact_3_phone","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$number = 2042;
	...
	$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"contact_3_mobile",  "Field Label"=>"Third contact mobile phone number", "Field No"=>$number, "LINC Name"=>"contact_3_mobile","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"emergency1_comment",  "Field Label"=>"Emergency contact 1 comment", "Field No"=>$number, "LINC Name"=>"emergency1_comment","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
...
$this->moe[$number]=array("Content Type"=> 'metacontent', "Field Name"=>"emergency2_comment",  "Field Label"=>"Emergency Contact 2 comment", "Field No"=>$number, "LINC Name"=>"emergency2_comment","Mandatory"=>"NO","Type"=>"ASCII"
, 'valid'=>'',
'value' =>'', 'message' =>'',
'input_field'=>'',
'input_label'=>'',
